...
- `/app/:tenantSlug` มี server-side search + pagination ในตารางบิล และ drilldown read-only สำหรับบิลขาย โดยรายการสินค้าในบิลดึงจาก SML แบบ on-demand ด้วย approved SQL ตามช่วงวันที่ที่กำลังดู
