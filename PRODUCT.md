...
Calm, precise, operational. The interface should feel like a dependable control room for real stores, not a marketing site or a decorative analytics demo.

## Anti-references

Avoid landing-page composition, decorative dashboards, oversized hero sections, vague AI copy, glass effects, nested cards, and hiding core configuration in modals. Avoid exposing technical connection details to customer viewers when "ข้อมูลจาก SML" is enough.

## Design Principles

- Make the next operational action obvious, especially when a tenant is not ready.
...
Target WCAG AA contrast for text and controls. Use standard form controls, visible focus, clear disabled states, concise Thai error messages, and responsive layouts that work from mobile widths through desktop operations screens.
