...
- ใช้ Flex bubble แบบ executive alert ที่สั้นกว่าปกติ
- แสดงเฉพาะสถานะ, ยอดขาย `0.00 บาท`, จำนวนบิล/รายการ, สิ่งที่ควรตรวจ, และปุ่ม `เปิดรายงาน`
- ซ่อนหมวด `ยอดหลัก` และ `สินค้าขายดี` ถ้าไม่มีข้อมูลจริง
- ไม่ใช้ wording แบบ alarm เช่น `ลดลง -100%` ใน bubble; ให้ใช้ข้อมูลอ้างอิงแบบนุ่ม เช่น `วันก่อนหน้ามียอดขาย ...`
